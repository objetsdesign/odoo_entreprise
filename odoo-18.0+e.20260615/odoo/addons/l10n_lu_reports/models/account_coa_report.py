...
class AccountChartOfAccountReport(models.AbstractModel):
    ...
    def l10n_lu_coa_report_get_account_fields(self, options, account_dict, year):
        ...
        if year >= 2020:
            ...
            account_fields.pop('2955', None)  # Must always be blank per: https://ecdf-developer.b2g.etat.lu/ecdf/forms/popup/CA_PLANCOMPTA/2020/en/2/rules pages 116 + 117
            account_fields['2956'] = 0.00  # Must always be zero ^^
